  ...
  return (
    <section className="w-full py-20 md:py-32">
      <div className="container mx-auto px-4 md:px-6">
        <div className="max-w-4xl mx-auto text-center bg-card/50 backdrop-blur-sm p-8 md:p-12 rounded-2xl shadow-lg relative overflow-hidden border border-border/50">
